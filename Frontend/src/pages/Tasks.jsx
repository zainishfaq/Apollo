        ...
        <div className="text-2xl font-medium bg-white text-black -mt-4 -mr-4 -ml-4 border-b border-gray-200 px-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="bg-blue-700 text-white rounded-md p-1 text-sm mt-5 mr-4"
            >
              Create Task
            </button>
          </div>
      ...
      <div className="flex h-screen ml-56 mt-24">
        ...
        <div className="flex-1 bg-white p-4">
          <div className="flex items-center mb-4">
            ...
            <button className="bg-blue-100 w-24 h-12 m-0 p-0   ml-4">
              {" "}
              <span>0</span>
              <br />
              Total
          ...
          <div className="border-t border-gray-200 pt-4">
            <div className="flex flex-row">
              ...
              <div className="ml-14 mt-1">
                ...
                <button className="border border-gray-400 p-2">
                  {" "}
                  <FaEllipsisV className=" text-sm text-gray-400" />
                </button>
              </div>
              <button className="ml-96 mt-1 w-32 h-8 border border-gray-400">
                Due Date
              </button>
              <button className="border border-gray-400 p-2 h-8 mt-1">
                <FaClock className=" text-sm text-gray-400" />
              </button>
            </div>
            <div className="flex justify-between items-center mb-2 my-6">
              <span>Task</span>
            ...
            <div className="text-center py-8 my-8">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-lg my-8">
                  You've completed all your tasks for today! Check again later
                  for any updates.
                </p>
              </div>
            </div>
