...
function ve({ children: e7, enabled: t11 = true }) {
  ...
  let { refs: b7, floatingStyles: w10, context: g6 } = useFloating2({ open: i15, placement: a19 === "selection" ? f21 === "center" ? "bottom" : `bottom-${f21}` : f21 === "center" ? `${a19}` : `${a19}-${f21}`, strategy: "absolute", transform: false, middleware: [offset2({ mainAxis: a19 === "selection" ? 0 : C7, crossAxis: M8 }), shift2({ padding: p7 }), a19 !== "selection" && flip2({ padding: p7 }), a19 === "selection" && P8 ? inner({ ...P8, padding: p7, overflowRef: c14, offset: r18, minItemsVisible: q, referenceOverflowThreshold: p7, onFallbackChange(h8) {
    var O6, W7;
    if (!h8) return;
